...
function commercialPrice(p){const n=Number(p?.preco);return Number.isFinite(n)&&n>0?{label:money(n),consult:false}:{label:'Sob consulta',consult:true}}
