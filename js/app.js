...
document.querySelectorAll('.mobile-services-menu a').forEach(link=>link.addEventListener('click',()=>{const details=link.closest('details');if(details)details.open=false}));
